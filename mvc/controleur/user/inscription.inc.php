<?php
/*======= C O N T R O L E U R ====================================================================================
	fichier				: ./mvc/controleur/film/inscription.inc.php
	auteur				: Loris Fariello
	date de création	: octobre 2019
	date de modification:
	rôle				: le contrôleur de la page d'inscription des films
  ================================================================================================================*/
 ...
 */
class controleurUserInscription extends controleur {
